                ...
                <div className="row">
                    ...
                    <div className='dashboard-support'>
                            <div className='dashboard-supporters'>
                                <img src="./logo/medal.png" alt="medal" width="50px" height="50px" />
                                <div>
                            ...
                            <div className='dashboard-supporters'>
                                <img src="./logo/thought.png" alt="thought" width="50px" height="50px" />
                                <div>
                                    <span>Knowledge</span>
                            ...
                            <div className='dashboard-supporters'>
                                <img src="./logo/training.png" alt="training" width="50px" height="50px" />
                                <div>
                    ...
                    <div className="col-md-6">
                       <div className='dashboard-image'>
                            <img src="./img/AboutDashboard.png" alt="Dashboard" width="100%"/>
                        </div>
                    </div>
                </div>
            </div>
